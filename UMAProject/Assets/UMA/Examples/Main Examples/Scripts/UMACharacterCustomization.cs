...
namespace UMA.Examples
{
    public class UMACharacterCustomization : MonoBehaviour
    {
        ...
        private void InitSliders()
        {
            ...
            //sliderControlList[18] = bodyGO.Find("SkinColor").GetComponent<Slider>();
            ...
            //sliderControlList2[15] = topHeadGO.Find("HairColor").GetComponent<Slider>();
            //sliderControlList2[15].maxValue = hairColors.Length - 1;

            //sliderControlList2[16] = topHeadGO.Find("EyeColor").GetComponent<Slider>();
            //sliderControlList2[16].maxValue = eyeColors.Length - 1;

            //sliderControlList2[17] = topHeadGO.Find("HairType").GetComponent<Slider>();
            ...
            //sliderControlList3[13] = lowHeadGO.Find("FacialHair").GetComponent<Slider>();
